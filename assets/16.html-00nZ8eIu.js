import{_ as n,o as s,c as a,b as t}from"./app-LuATGSRb.js";const p={},c=t(`<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2><p>命令模式：有时候需要向某些对象发送请求，但是并不知道请求的接受者是谁，也不知道被请求的操作是什么。需要 一种松耦合的方式来设计程序，是得发送者和接收者能够消除彼此之间的耦合关系。 命令模式有三个角色构成</p><ol><li>发布者 invoker：发出命令，调用命令对象，不知道如何执行与谁执行</li><li>接收者 receiver:(提供对应接口处理请求，不知道谁发起请求)</li><li>命令对象 command：(接收命令，调用接收者对应接口处理发布者的请求)</li></ol><h2 id="示例" tabindex="-1"><a class="header-anchor" href="#示例" aria-hidden="true">#</a> 示例</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Receiver</span> <span class="token punctuation">{</span>
